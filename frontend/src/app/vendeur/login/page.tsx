/**
 * Page de connexion pour les vendeurs
 * 
 * Permet aux vendeurs de se connecter à leur espace
 * avec leur email et mot de passe
 */
'use client';
...
export default function VendorLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem('vendorToken', data.id); // Pour l'instant, on utilise l'ID comme token
